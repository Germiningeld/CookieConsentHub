export class ConsentNotification {
    constructor(cookieConsent) {
        console.log('ConsentNotification: constructor called with cookieConsent:', cookieConsent);
        ...
        if (!cookieConsent) {
            console.error('ConsentNotification: cookieConsent is undefined');
            throw new Error('cookieConsent is required');
        }
    ...
    show() {
        ...
        console.log('ConsentNotification: Modal and overlay shown');
    }
    ...
    hide() {
        ...
        console.log('ConsentNotification: Modal and overlay hidden');
    }
